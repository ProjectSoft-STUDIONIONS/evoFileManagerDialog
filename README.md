...
| --- | --- | --- | --- |
| EvoFileManagerDialog Evolution CMS | Чернышёв Андрей aka ProjectSoft <projectsoft2009@yandex.ru> | 2017-11-24  | 2026-02-02 |
...
#### -- 1.2.9
Подправлена работа под EvolutionCMS 3.x.x.
#### -- 1.2.8
